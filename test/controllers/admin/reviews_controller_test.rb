...
class Admin::ReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_review" do
    assert_difference('Admin::Review.count') do
      post admin_reviews_url, params: { admin_review: { author: @admin_review.author, confirmed: @admin_review.confirmed, email: @admin_review.email, review_body: @admin_review.review_body } }
    end
  ...
  test "should update admin_review" do
    patch admin_review_url(@admin_review), params: { admin_review: { author: @admin_review.author, confirmed: @admin_review.confirmed, email: @admin_review.email, review_body: @admin_review.review_body } }
