...
class Admin::RoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_room" do
    assert_difference('Admin::Room.count') do
      post admin_rooms_url, params: { admin_room: { description: @admin_room.description, image: @admin_room.image, number: @admin_room.number } }
    end
  ...
  test "should update admin_room" do
    patch admin_room_url(@admin_room), params: { admin_room: { description: @admin_room.description, image: @admin_room.image, number: @admin_room.number } }
